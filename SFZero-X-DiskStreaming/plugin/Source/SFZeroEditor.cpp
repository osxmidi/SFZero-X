...
String loadstring = "";
  ...
  File sfile = juce::File::getSpecialLocation(File::userHomeDirectory).getChildFile(".sfzero-x-ds");
...
void sfzero::SFZeroEditor::showVersion()
{
  ...
  auto str = String::formatted("SFZero-X-ds beta %d.%d.%d", date.getYear(), date.getMonth(), date.getDayOfMonth());
