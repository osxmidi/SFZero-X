...
public:
  ...
  void startNote(const EGParameters *parameters, int midiNoteNumber, float floatVelocity, double sampleRate, float delaytime, const EGParameters *velMod = nullptr);
  void nextSegment();
  void noteOff();
  void fastRelease();
