...
To make the Projucer change into ~/JUCE/extras/Projucer/Builds/LinuxMakefile then enter into the Terminal, make CONFIG=Release CPPFLAGS=-DJUCER_ENABLE_GPL_MODE=1
